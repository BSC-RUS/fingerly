...
public class TouchIdCodes {
	...
	//error codes
	public static final int FINGERPRINT_ERROR_HW_UNAVAILABLE = 1; //The operation was canceled because the fingerprint sensor is unavailable.
	public static final int FINGERPRINT_ERROR_UNABLE_TO_PROCESS = 2; //Error state returned when the current request has been running too long.
	public static final int FINGERPRINT_ERROR_TIMEOUT = 3; // Error state returned for operations like enrollment; the operation cannot be completed because there's not enough storage remaining to complete the operation.
	public static final int FINGERPRINT_ERROR_NO_SPACE = 4; //The operation was canceled because the API is locked out due to too many attempts.
